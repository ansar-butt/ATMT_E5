for ((i = 3 ; i < 25 ; i = i + 3 )); do 
    python translate_beam.py --data data/en-fr/prepared --dicts data/en-fr/prepared --checkpoint-path assignments/03/baseline/checkpoints/checkpoint_best.pt --output assignments/03/baseline/translations.txt --beam-size $i
